...
function renderPreloadLink(file) {
    ...
    //--- CSS stylesheets.
    else if (file.endsWith('.css')) return `<link rel="preload" as="style" importance="hihh" href="${file}">`
    ...
    else if (file.endsWith('.jpg')) return ` <link rel="preload" href="${file}" as="image" type="image/jpeg">`
    else if (file.endsWith('.jpeg')) return ` <link rel="preload" href="${file}" as="image" type="image/jpeg">`
